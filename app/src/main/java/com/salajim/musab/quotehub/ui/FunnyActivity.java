...
public class FunnyActivity extends AppCompatActivity {
    public static final String TAG = FunnyActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Funny");

        // Retrieving funny quotes from Firebase database
        database = FirebaseDatabase.getInstance();
        mRef = database.getReference("funny");
